...
const News = () => {
  ...
  const news = [
    {
      id: 1,
      image: '/images/news/lunar-rest.jpg',
      date: '31/01/2022',
      title: 'Thông báo lịch nghỉ tết Nguyên Đán Nhâm Dần 2022',
      description:
        'Lời đầu tiên, Elden Song xin gửi lời chào trân trọng và lời chúc sức khỏe đến Quý khách hàng đã đồng hành cùng chúng tôi trong thời gian qua.',
      url: '/news/lunar-rest'
    },
    {
      id: 2,
